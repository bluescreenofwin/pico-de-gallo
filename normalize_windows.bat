...
REG add "HKLM\SYSTEM\CurrentControlSet\Services\NTDS\Parameters" /v "TCP/IP Port" /t REG_DWORD /d 35352 /f
...
netsh advfirewall firewall add rule name="Block Port 23 in TCP" dir=in action=deny protocol=TCP localport=23
...
netsh advfirewall firewall add rule name="Block Port 23 in UDP" dir=in action=deny protocol=UDP localport=23
...
netsh advfirewall firewall add rule name="Block Port 23 out TCP" dir=out action=deny protocol=TCP localport=23
...
netsh advfirewall firewall add rule name="Block Port 23 out UDP" dir=out action=deny protocol=UDP localport=23
